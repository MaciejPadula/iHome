...
import { AddWidgetResponse } from 'src/app/shared/models/add-widget-response';
...
export class WidgetsService {
  ...
  public addWidget(widgetType: WidgetType, roomId: string, showBorder: boolean): Observable<AddWidgetResponse> {
    return this._api.post<AddWidgetResponse>(this._baseApiUrl + 'AddWidget', {
      widgetType,
      roomId,
      showBorder
    });
